    ...
    public class CinemaServices
    {
        public string? SaveImg(IFormFile actorImg)
        {
            try
            {
                ...
                var filePath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot\\Images_Layout\\Admin\\CinemaImage", fileName);
        ...
        public bool DeleteImg(string imgName)
        {
            try
            {
                var filePath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot\\Images_Layout\\Admin\\CinemaImage", imgName);
